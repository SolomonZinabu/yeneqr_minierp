// ============================================================
// Yene QR — Admin Entertainment Content API (Platform-wide)
// GET: List all platform-wide entertainment content with pagination
// POST: Create new platform-wide content (super admin only)
// ============================================================
 ...
 * List all platform-wide entertainment content with pagination.
 *
 * Query params:
...
export async function GET(request: NextRequest) {
  try {
    ...
    const where: Record<string, unknown> = {
      restaurantId: null, // Platform-wide only
    }
    ...
    console.error('[ADMIN_ENTERTAINMENT_LIST]', error)
    return NextResponse.json(
 ...
 * Create new platform-wide content (super admin only).
 *
 * Body: {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[ADMIN_ENTERTAINMENT_CREATE]', error)
    return NextResponse.json(
