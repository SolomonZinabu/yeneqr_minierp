// Shared type definitions for Yene QR platform
// Extracted from mock-data.ts — all dashboard views now use real APIs

// ===== Restaurant & Ordering Types =====

export type OrderStatus = 'pending' | 'confirmed' | 'preparing' | 'ready' | 'served' | 'completed' | 'cancelled';
export type KitchenItemStatus = 'pending' | 'preparing' | 'ready' | 'served';
export type TableStatus = 'available' | 'occupied' | 'reserved' | 'cleaning';
export type StaffRole = 'owner' | 'manager' | 'cashier' | 'waiter' | 'kitchen_staff';
